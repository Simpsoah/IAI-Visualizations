    ...
    ajaxRequest.onreadystatechange = function() {
        if (ajaxRequest.readyState == 4 && ajaxRequest.status == 200) {
            ...
            TODO: Last index is null.Whyyyy ?
                head.ready(Object.keys(loadedScripts[loadedScripts.length - 2]), 
                function() {
...
(function() {
    ...
    head.js(
        ...
        { 'ComponentEdgeOpacityLegend.js': 'visuals/component/ComponentEdgeOpacityLegend.js' }, 
        { 'ComponentNodeStrokeLegend.js': 'visuals/component/ComponentNodeStrokeLegend.js' }, 
        { 'NodeFocus.js': 'visuals/component/NodeFocus.js' }, 
        { 'mainVis-configs.js': 'visuals/mainVis-configs.js' }, 
        { 'nodeFocus-configs.js': 'visuals/nodeFocus-configs.js' }, 
        { 'barVis-configs.js': 'visuals/barVis-configs.js' }, 
        { 'style.css': 'css/style.css' }, 
